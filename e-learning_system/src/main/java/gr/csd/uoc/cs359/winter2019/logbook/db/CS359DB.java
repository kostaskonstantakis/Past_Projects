...
public class CS359DB {
    ...
    private static final String UNAME = "csd4076"; // Share your repo to give you the credentials
    private static final String PASSWD = "8A3EN%T5";  // Share your repo to give you the credentials
