 ...
 * @author George
 */
@WebServlet(urlPatterns = {"/printUserProfile"})
public class printUserProfile extends HttpServlet {
        ...
        List<Post> postsOutput;
           ...
           // System.out.println("*************");
            ...
            response_json.put("posts",userPosts);
              ...
              if(username.contentEquals(user))
            {
            response_json.put("user", "same");
            }
            else
              {
                   response_json.put("user","diff");
              }
            ...
            Logger.getLogger(printUserProfile.class.getName()).log(Level.SEVERE, null, ex);
        }
